...
def load_config() -> GlobalContext:
    ...
    comparison = (
        ProductData(**data["comparison_product"])
        if "comparison_product" in data
        else None
    )

    return GlobalContext(
        product_input=product, comparison_input=comparison, stage=ProcessingStage.INGEST
    )
...
def generate_product_page_json(context: GlobalContext) -> dict:
    ...
    data = {
        ...
        "usage_instructions": context.generated_content.usage
...
def generate_comparison_json(context: GlobalContext) -> dict:
    ...
    data = {
        ...
        "recommendation": comparison_data.get(
            "recommendation", "No comparison available."
        ),
