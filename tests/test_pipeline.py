...
from skincare_agent_system.data.products import (  # noqa: E402
    GLOWBOOST_PRODUCT,
    RADIANCE_PLUS_PRODUCT,
)
from skincare_agent_system.generate_content import (  # noqa: E402
...
class TestPipeline:
    ...
    def test_generate_comparison_page(self, output_dir):
        ...
        result = generate_comparison_page(
            GLOWBOOST_PRODUCT, RADIANCE_PLUS_PRODUCT, output_path
        )
    ...
    def test_full_pipeline(self, output_dir):
        ...
        generate_faq_page(GLOWBOOST_PRODUCT, faq_path)
        generate_product_page(GLOWBOOST_PRODUCT, product_path)
        generate_comparison_page(
            GLOWBOOST_PRODUCT, RADIANCE_PLUS_PRODUCT, comparison_path
        )
