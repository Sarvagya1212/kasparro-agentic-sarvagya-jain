...
class Message:
    ...
    def create_response(
        self, payload: Dict[str, Any], success: bool = True
    ) -> "Message":
...
class MessageRouter:
    ...
    def register_handler(
        self, agent_name: str, handler: Callable[[Message], Optional[Message]]
    ) -> None:
    ...
    def clear_expired(self) -> int:
        ...
        expired = [mid for mid, msg in self._pending_acks.items() if msg.is_expired()]
        for mid in expired:
...
class AgentMessenger:
    ...
    def tell(
        self, receiver: str, notification: str, data: Optional[Dict[str, Any]] = None
    ) -> bool:
        """
    ...
    async def bid(
        self, receiver: str, task: str, offer: Dict[str, Any], timeout: float = 5.0
    ) -> Optional[str]:
        """
