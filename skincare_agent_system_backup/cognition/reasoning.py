...
- Is Validated: {'Yes' if context.is_valid else 'No'}
            ...
            f"{len(context.generated_questions) if context.generated_questions else 0}"
            f"\n"
...
class TaskDecomposer:
    ...
    def _decompose_with_llm(self, goal: str, llm) -> List[SubTask]:
        ...
        prompt = (
            f"Break down this goal into 3-6 sub-tasks:\n\n"
            f"Goal: {goal}\n\n"
            ...
            '      "assigned_agent": "AgentName"}\n'
            "]\n\n"
            "Available agents: DataAgent, SyntheticDataAgent, DelegatorAgent, "
...
Evaluate these possible next steps. Assign a score (0.0 to 1.0) for how likely
each step leads to a successful solution.
